...
import Image from 'next/image'; //Uma das features do next que faz a optimização de imagem. Diminui a qualidade/tamanho da imagem automaticamente
import logo from '@/assets/logo.svg'
import { SubscriptionForm } from './subscription-form'

export default function Home() {
    return (
        <div className="min-h-dvh flex flex-col justify-center gapt-16">
